...
<!--PATTERN ietf-system-->
	...
	<!--RULE -->
<axsl:template match="/nc:config/sys:system/sys:dns-resolver/sys:search" priority="1004" mode="M5"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/nc:config/sys:system/sys:dns-resolver/sys:search"/>
...
<axsl:if test=". = preceding-sibling::sys:search"><svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test=". = preceding-sibling::sys:search"><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>Duplicate leaf-list entry "<axsl:text/><axsl:value-of select="."/><axsl:text/>".</svrl:text></svrl:successful-report></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/nc:config/sys:system/sys:dns-resolver/sys:server" priority="1003" mode="M5"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/nc:config/sys:system/sys:dns-resolver/sys:server"/>
