...
int main(int argc, char** argv){
    ...
    for(itr = ap_num ; itr > 0 ; --itr)
    {
        ...
        if(childPID){
            ...
            gquiz1.insert( pair< int, char * > (itr,msg)); 
    ...
    if(childPID){
        ...
        //Open all fds with pathname from map
        //map pathname to fd simultaneously
        //read-write fifo [replace by select based read-write]
